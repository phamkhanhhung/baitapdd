package com.khanhhung.timepicker_datepicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<Job_in_Week>arrJob=new ArrayList<Job_in_Week>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter<Job_in_Week>adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<Job_in_Week>
                (this,
    ...
    public void processAddJob()
    {
        ...
        Job_in_Week job=new Job_in_Week(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
